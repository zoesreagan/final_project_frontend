...
class EditForm extends Component {
  ...
  this.setState({
    dateCreated: this.props.formToEdit.form.date_created,
    responseOne: this.props.formToEdit.form.response_1,
    responseTwo: this.props.formToEdit.form.response_2,
    responseThree: this.props.formToEdit.form.response_3,
    responseFour: this.props.formToEdit.form.response_4,
    responseFive: this.props.formToEdit.form.response_5,
    responseSix: this.props.formToEdit.form.response_6,
    responseSeven: this.props.formToEdit.form.response_7,
    responseEight: this.props.formToEdit.form.response_8,
    responseNine: this.props.formToEdit.form.response_9
  })
}
